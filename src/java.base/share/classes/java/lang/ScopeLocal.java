 ...
 * inheritance by {@link java.util.concurrent.StructuredExecutor} threads to be
...
public final class ScopeLocal<T> {
    ...
    /**
     * An immutable map from a set of ScopeLocals to values.  When {@link #run} or
     * {@link #call} is invoked, the ScopeLocals bound in this set are bound, such that
     * calling the {@link ScopeLocal#get} method returns the associated value.
     */
    @PreviewFeature(feature=SCOPE_LOCALS)
