 ...
 *
 * <p> A extent-local variable (hereinafter called an extent local) differs from a normal variable in that it is dynamically
 ...
 *
 * <p> Extent locals support nested bindings. If a extent local has a value
 ...
 * hold those values, and then bind a single extent-local variable to an instance of that
 * record.
 *
