...
private:
 ...
 public:
  ...
  void runWithExtentLocalBindings(jobject jthread, jobject bindings, jobject runnable, TRAPS);
  oop callWithExtentLocalBindings(jobject jthread, jobject bindings, jobject callable, TRAPS);
