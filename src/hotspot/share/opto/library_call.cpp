...
bool LibraryCallKit::try_to_inline(int predicate) {
  ...
  case vmIntrinsics::_unsafeSetScopeLocalCache: return inline_native_unsafeSetScopeLocalCache();
...
//------------------------inline_native_unsafeSetScopeLocalCache------------------
bool LibraryCallKit::inline_native_unsafeSetScopeLocalCache() {
